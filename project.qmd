...
$$
According to OECD definition, an [unemployed individual]{.mark} is a working age individual that is not employed, is available to work and has been actively looking for employment during a reference period. The [unemployment rate]{.mark} is therefore defined as the percentage share of unemployed individuals in total labor force, given by:
$$
