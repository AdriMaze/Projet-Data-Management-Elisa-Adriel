...
The Phillips curve is a fundamental concept in economics, and the basis of most neo-models, whether it be from classic or more keynesian schools. It was first observed a negative relationship between unemployment and inflation rate, but as time passes, and accross countries as well, this relationship is less and less true. Our question concerns the fundamental and exogenous principles behind the horizontalisation of the Phillips curve. Indeed, there could be multiple reasons as to why we do not observe this relationship anymore: the structures of the economies changed, the globalization had an impact on the fundamental relationship, the policy regimes' changes contributed to flatten the relationship...

on veut analyser les changements dans la courbature dans la courbe de
philipps. avant on remarquait qu'elle était décroissante alors que
maintenant on remarque que cette relation elle existe presqque plus. on
veut donc analyser pourquoi elle existe plus : 1/ évolution dans le
temps et 2/ quels sont les éléments qui l'ont aplati en fonction des
périodes. donc notre question c'est pourquoi elle s'est horizontalisé en
fonction des périodes. on va utiliser un modele DiD.

1er partie : focus ajd, covid bcp d'inflation et réaction au chômage.
constats actuels de la courbe de philips.

2eme : analyse temporelle diviser en 3 périodes (avant 1990, 1990/2008
puis après 2008)

3eme : focus sur certains chocs particuliers (on sait pas encore
lesquels)

obj : analyser les covariables principales de l'horizontalisation
