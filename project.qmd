...
final_table |>
  mutate(
    slope_contribution     = round(slope_contribution, 4),
    curvature_contribution = round(curvature_contribution, 4)
  ) |>
  arrange(period, country, desc(abs(slope_contribution))) |>
  kable(
    ...
    caption = "Country- and Period-Specific Contributions of Structural Variables to the Phillips Curve"
  ) |>
  kable_styling(
    latex_options = c("hold_position", "repeat_header"),
    font_size = 9
  ) |>
  column_spec(1, bold = TRUE) |>   # country
  column_spec(2, italic = TRUE) |> # period
